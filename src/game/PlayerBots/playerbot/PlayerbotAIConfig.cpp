...
bool PlayerbotAIConfig::Initialize()
{
    ...
    groupMemberLootDistanceWithActiveMaster = config.GetFloatDefault("AiPlayerbot.GroupMemberLootDistanceWithActiveMaster", 30.0f);
    ...
    botActiveAloneDungeon = config.GetIntDefault("AiPlayerbot.ActiveAloneDungeon", 10);
    botActiveAloneRaid = config.GetIntDefault("AiPlayerbot.ActiveAloneRaid", 10);
    botActiveAloneBattleground = config.GetIntDefault("AiPlayerbot.ActiveAloneBattleground", 10);
    ...
    continentInstancedTeleport = config.GetBoolDefault("AiPlayerbot.ContinentInstancedTeleport", false);
    continentInstancedTeleportOverloadMs = config.GetIntDefault("AiPlayerbot.ContinentInstancedTeleportOverloadMs", 80);
    continentInstancedTeleportUnderloadMs = config.GetIntDefault("AiPlayerbot.ContinentInstancedTeleportUnderloadMs", 45);
    continentInstancedTeleportActivityThreshold = config.GetIntDefault("AiPlayerbot.ContinentInstancedTeleportActivityThreshold", 50);
