...
namespace ai
{
   ...
   protected:
       ...
       const WorldPosition GetBestPoint(Unit* anchor, const std::list<Unit*>& hostiles, bool outerOnly,
                                        ...
                                        Unit* rangeTarget = nullptr, float preferredDistance = 0.0f,
                                        bool preferOpenSpace = false) const;
       ...
       bool IsEmergencyEscapePath(const WorldPosition& point, const std::list<Unit*>& hostiles) const;
   };
